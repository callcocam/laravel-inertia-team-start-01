...
mix.js('resources/_dist/admin/js/app.js', 'public/_dist/admin/js')
    ...
    .sass('resources/_dist/admin/sass/pages/dashboard-analytics.scss', 'public/_dist/admin/app-assets/css/pages/dashboard-analytics.css')
    .sass('resources/_dist/admin/sass/pages/card-analytics.scss', 'public/_dist/admin/app-assets/css/pages/card-analytics.css')
    .sass('resources/_dist/admin/sass/plugins/tour/tour.scss', 'public/_dist/admin/app-assets/css/plugins/tour/tour.css')
